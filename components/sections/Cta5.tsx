          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mt-lg-0 mt-5">
                <h5 className="ds-5">Your Questions, Answered</h5>
                <p className="fs-5 my-4">
                  At Solution Spire, we understand that you may have questions
                  about our services, processes, and how we can help your
                  business succeed. To make things easier, we’ve compiled
                  answers to some of the most common inquiries. If you don’t
                  find the information you’re looking for, feel free to reach
                ...
                <div className="accordion">
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    <div className="px-0 card-header border-0 bg-gradient-1">
                      ...
                      >
                        ...
                        <h6 className="m-0">
                          What services does Solution Spire offer?
                        </h6>
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600">
                        ...
                        development, UI/UX designing, mobile application
                        development, software development, graphic designing,
                        and SEO/digital marketing services.
                      </p>
                    </div>
                  </div>
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600">
                        The timeline varies depending on the scope and
                        complexity of the project. After understanding your
                        requirements, we provide a detailed timeline tailored to
                        your needs.
                      </p>
                    </div>
                  </div>
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600">
                        Yes, all our solutions are fully customized to align
                        with your unique business goals and challenges.
                      </p>
                    </div>
                  </div>
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    <div className="px-0 card-header border-0 bg-gradient-1">
                      ...
                      >
                        ...
                        <h6 className="m-0">
                          Can I request updates or changes during the project?
                        </h6>
                        <span className="ms-auto arrow me-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600">
                        Absolutely! We maintain open communication throughout
                        the process and accommodate updates to ensure your
                        satisfaction.
                      </p>
                    </div>
                  </div>
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    <div className="px-0 card-header border-0 bg-gradient-1">
                      ...
                      >
                        ...
                        <h6 className="m-0">
                          How do I get started with Solution Spire?
                        </h6>
                        <span className="ms-auto arrow me-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600">
                        Simply contact us through our website or email us with
                        your project requirements. Our team will get in touch to
                        discuss your needs and guide you through the next steps.
                      </p>
                    </div>
                  </div>
                </div>
