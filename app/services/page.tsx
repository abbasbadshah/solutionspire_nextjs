      ...
      <Layout headerStyle={4} footerStyle={3}>
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p data-aos="fade-zoom-in" data-aos-delay={100}>
                ...
                <br /> whether you have enough working capital.
              </p>
            </div>
            <div className="row mt-6 position-relative">
              <div className="col-lg-4">
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-4">
                    <img
                      src="/assets/imgs/service-1/webdevelopment.png"
                      alt="webdevelopment"
                    />
                    <h6 className="my-3">Web Development</h6>
                    <p className="mb-6">
                      {" "}
                      Crafting dynamic, responsive, and user-friendly websites
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-3">
                    ...
                    <p className="mb-6">
                      Designing intuitive interfaces that enhance user
              ...
              <div className="col-lg-4">
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-3">
                    <img
                      src="/assets/imgs/service-1/softwaredevelopment.png"
                      alt="softwaredevelopment"
                    />
                    <h6 className="my-3">Software Development</h6>
                    <p className="mb-6">
                      Building custom software solutions to streamline
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-3">
                    <img
                      src="/assets/imgs/service-1/graphic.png"
                      alt="graphic designing"
                    />
                    <h6 className="my-3">Graphic Designing</h6>
                    <p className="mb-6">
                      Creating compelling visuals and designs that leave a
                      lasting impression.
                    </p>
                    {/* <Link href="#" className="rounded-pill border icon-shape d-inline-flex gap-3 icon-learn-more">
										<svg className="plus" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
              ...
              <div className="col-lg-4">
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-3">
                    <img
                      src="/assets/imgs/service-1/mobileappdevelopment.png"
                      alt="mobileappdevelopment"
                    />
                    <h6 className="my-3">Mobile Application Development</h6>
                    <p className="mb-6">
                      Developing seamless, feature-rich mobile apps for iOS and
                      Android platforms.
                    </p>
                    {/* <Link href="#" className="rounded-pill border icon-shape d-inline-flex gap-3 icon-learn-more">
										<svg className="plus" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
                ...
                >
                  <div className="card-service bg-white p-6 border rounded-3">
                    <img
                      src="/assets/imgs/service-1/seo.png"
                      alt="digital marketing and seo"
                    />
                    <h6 className="my-3">SEO and Digital Marketing</h6>
                    <p className="mb-6">
                      Elevating your online presence with data-driven SEO
                      strategies and impactful digital campaigns.
                    </p>
                    {/* <Link href="#" className="rounded-pill border icon-shape d-inline-flex gap-3 icon-learn-more">
										<svg className="plus" xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
											<g clipPath="url(#clip0_226_5470)">
        ...
        <section className="section-newsletter-1 pb-120 pt-120 fix position-relative">
          <div className="container position-relative fix">
            ...
            <div className="position-absolute top-50 start-50 translate-middle z-0">
              <img
                src="/assets/imgs/newsletter-1/bg-line.png"
                alt="Solution Spire"
              />
            </div>
            <div className="bouncing-blobs-container rounded-4 fix">
