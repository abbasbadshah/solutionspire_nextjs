          ...
          <div className="container">
            ...
            <div className="row pt-8">
              <div className="col-lg-4 sidebar">
                <Link
                  href="#"
                  className="btn btn-outline-secondary-2 w-100 text-start mb-2 fs-5 py-3 d-flex justify-content-between align-items-center"
                >
                ...
                <div className="bg-primary rounded-4 mt-5 position-relative">
                  <div className="p-7">
                    ...
                    <Link
                      href="#"
                      className="fw-bold btn text-start bg-white fs-6 d-flex align-items-center justify-content-between text-primary hover-up w-100"
                    >
                ...
                <div className="bg-neutral-100 p-5 mt-5 rounded-4 border">
                  ...
                  <div className="row mt-5">
                    ...
                    <div className="col-12">
                      <button
                        type="submit"
                        className="btn btn-primary hover-up mt-4 w-100 d-flex align-items-center justify-content-between"
                      >
                        Send Message
                        <svg
                          className="ms-2"
              ...
              <div className="col-lg-8 ps-lg-4 mt-lg-0 mt-8 content">
                ...
                <p className="mb-0">
                  ...
                  services are designed to help you navigate the complexities of
                  the modern marketplace, leveraging cutting-edge technology and
                  forward-thinking strategies to transform your operations and
                  achieve your goals. We implement intelligent automation tools
                ...
                <h4 className="mt-3 pt-3 border-top mb-3">
                ...
                <p className="fw-bold text-900">
                  ...
                  <span className="fw-medium text-600">
                    Foster a culture of innovation within your organization. We
                    facilitate ideation sessions and help you develop viable
                    concepts that can be turned into profitable ventures.
                  </span>
                </p>
                <p className="fw-bold text-900">
                  RD Support:{" "}
                  <span className="fw-medium text-600">
                    Accelerate your research and development efforts with our
                    expert support. We provide the resources and expertise
                    needed to bring your innovative ideas to life.
                  </span>
                </p>
                <p className="fw-bold text-900">
                  Intellectual Property Management:{" "}
                  <span className="fw-medium text-600">
                    Protect your innovations with our comprehensive IP
                    management services. From patent filing to trademark
                    registration, we safeguard your intellectual assets.
                  </span>
                </p>
                <p className="fw-bold text-900">
                  ...
                  <span className="fw-medium text-600">
                    ...
                    We provide you with actionable insights that help you
                    identify new opportunities and make informed strategic
                    decisions.
                  </span>
                </p>
                <p className="fw-bold text-900">
                  ...
                  <span className="fw-medium text-600">
                    Reinvent your business model to meet the demands of today's
                    market. Our experts help you create a flexible, scalable
                    model that drives
                  </span>
                </p>
                <h5 className="pt-3 border-top mb-3 mt-5">
                  ...
                  <div className="px-0 card p-3 border-0 border-bottom bg-transparent rounded-0">
                    ...
                    >
                      <p className="px-0 card-body fs-6 text-600 mb-0">
                        Getting started is simple! Download the app from the App
                        Store or Google Play Store, create an account using your
                        email or social media login, and start making video
                        calls instantly.
                      </p>
                    </div>
                  </div>
              ...
              <div className="col-lg-4">
                ...
                >
                  <p className="text-900">
                    ...
                    and aesthetically pleasing user interfaces that resonate
                    with our target audience. Equally impressive is the premium
                    support team's proactive approach.
                  </p>
                  <div className="d-flex align-items-center mt-5">
                    <img
                      className="avatar-lg"
